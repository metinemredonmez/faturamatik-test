...
const ChangePassword = () => {
  ...
  useEffect(() => {
    if (getUserData) {
      setPhone(getUserData[0].t_gsm_no);
  ...
  return (
    <View style={styles.container}>
      <Portal>
        <Modalize ref={successRef} snapPoint={460}>
          <View
            style={{
              display: 'flex',
              alignItems: 'center',
            ...
            />
            <Text bold align="center" size={20} color="#484848">
      ...
      <Portal>
        <Modalize ref={errorRef} snapPoint={460}>
          <View
            style={{
              display: 'flex',
              alignItems: 'center',
      ...
      <SafeAreaView style={{flex: 1, margin: 10}}>
        <Header title="Şifre Değiştir" leftSide={true} />
        <Card
